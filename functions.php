...
register_sidebar( array(
		'name'          => __( 'Header Stack Right', 'wpbase_domain' ),
		'id'            => 'headerstackright',
		'description'   => '',
		'class'         => '',
		'before_widget' => '<div class="stack content__right">',
		'after_widget'  => '</div>',
		'before_title'  => '<h4>',
		'after_title'   => '</h4>',
	) );
	register_sidebar( array(
		'name'          => __( 'Header Stack', 'wpbase_domain' ),
		'id'            => 'headerstack',
		'description'   => '',
		'class'         => '',
		'before_widget' => '<div class="stack">',
		'after_widget'  => '</div>',
		'before_title'  => '<h4>',
		'after_title'   => '</h4>',
	) );
	register_sidebar( array(
		'name'          => __( 'Header Container', 'wpbase_domain' ),
		'id'            => 'headercontainer',
		'description'   => '',
		'class'         => '',
		...
		register_sidebar( array(
		'name'          => __( 'Header Flex DESIGNER', 'wpbase_domain' ),
		'id'            => 'headerdesigner',
		'description'   => '',
		'class'         => '',
		'before_widget' => '<div class="header-design-item">',
		'after_widget'  => '</div>',
		'before_title'  => '<h4>',
		'after_title'   => '</h4>',
	) );
	register_sidebar( array(
		'name'          => __( 'Left', 'wpbase_domain' ),
		'id'            => 'left',
		'description'   => '',
		'class'         => '',
	...
	register_sidebar( array(
		'name'          => __( 'Info bar', 'wpbase_domain' ),
		'id'            => 'infobar',
		'description'   => '',
		'class'         => '',
		'before_widget' => '<div class="item">',
	...
	register_sidebar( array(
		'name'          => __( 'PRE Footer', 'wpbase_domain' ),
		'id'            => 'footerpre',
		'description'   => '',
		'class'         => '',
		'before_widget' => '<div class="item prefooter-design-item">',
		'after_widget'  => '</div>',
		'before_title'  => '<h4>',
		'after_title'   => '</h4>',
	) );
	register_sidebar( array(
		'name'          => __( 'Footer', 'wpbase_domain' ),
		'id'            => 'footer',
		'description'   => '',
		'class'         => '',
		'before_widget' => '<div class="item">',
...
load_theme_textdomain( 'wpbase_domain', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'header-menu' => __( 'Header Menu', 'wpbase_domain' ),
		'footer-menu' => __( 'Footer Menu', 'wpbase_domain' ),
	) );
...
parent::__construct(
			'hjemmesiderknap', // Base ID
			__( 'Info knap', 'wpbase_domain' ), // Name
			array( 'description' => __( 'Hjemmesider.dk - Knap til sliderbar', 'wpbase_domain' ), ) // Args
		);
	}
...
class hjemmesider_social_widget extends WP_Widget {
	...
	public function __construct() {
parent::__construct(
			'hjemmesidersocial', // Base ID
			__( 'Sociale ikoner', 'wpbase_domain' ), // Name
			array( 'description' => __( 'Hjemmesider.dk - Sociale ikoner', 'wpbase_domain' ), ) // Args
		);
	}
...
class hjemmesider_logo_widget extends WP_Widget {
	...
	public function __construct() {
parent::__construct(
			'hjemmesiderlogo', // Base ID
			__( 'Logo', 'wpbase_domain' ), // Name
			array( 'description' => __( 'Hjemmesider.dk - Logo, Sidetitel og Tagline ', 'wpbase_domain' ), ) // Args
		);
	}
...
class hjemmesider_logo_small_widget extends WP_Widget {
	...
	public function __construct() {
parent::__construct(
			'hjemmesiderlogosmall', // Base ID
			__( 'Logo clean', 'wpbase_domain' ), // Name
			array( 'description' => __( 'Hjemmesider.dk - Logo', 'wpbase_domain' ), ) // Args
		);
	}
...
class hjemmesider_loginform_widget extends WP_Widget {
	...
	public function __construct() {
parent::__construct(
			'hjemmesiderloginform', // Base ID
			__( 'Loginform', 'wpbase_domain' ), // Name
			array( 'description' => __( 'Hjemmesider.dk - Loginform', 'wpbase_domain' ), ) // Args
		);
	}
...
parent::__construct(
			'acfsocial', // Base ID
			__( 'Sociale links', 'wpbase_domain' ), // Name
			array( 'description' => __( 'Sociale link - ACF', 'wpbase_domain' ), ) // Args
		);
	}
...
if( function_exists('acf_add_options_page') ) {
	...
	acf_add_options_page(array(
		...
		'menu_title'	=> 'WPbase admin',
		'menu_slug' 	=> 'wpbase-general-settings',
	...
	acf_add_options_sub_page(array(
		...
		'menu_title'	=> 'Social',
		'parent_slug'	=> 'wpbase-general-settings',
	));
